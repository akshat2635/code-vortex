...
const EditorPanel = () => {
  ...
  const handleFontSizeChange = (val: number) => {
    const newFontSize = Math.min(Math.max(val, 12), 24);
    setFontSize(newFontSize);
    localStorage.setItem("editor-fontSize", newFontSize.toString());
  };
          ...
          {clerk.loaded ? (
            <Editor
              ...
              options={{
                ...
                fontFamily: '"Fira Code", monospace, "Cascadia Code", Consolas',
                lineNumbers: "on",
                fontLigatures: true,
