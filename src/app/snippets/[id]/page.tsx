    ...
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <main className="max-w-[85rem] mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="bg-[#121218] border border-[#ffffff0a] rounded-xl p-4 sm:p-5 mb-4 backdrop-blur-xl">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center size-10 rounded-lg bg-[#ffffff08] p-2">
                  <img
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs">
                    <div className="flex items-center gap-1.5 text-[#8b8b8d]">
              ...
              <div className="inline-flex items-center px-2.5 py-1 bg-[#ffffff08] text-[#808086] rounded-md text-xs font-medium">
                {snippet.language}
              </div>
            </div>
          </div>
          ...
          {/* Code Editor */}
          <div className="mb-4 rounded-xl overflow-hidden border border-[#ffffff0a] bg-[#121218]">
            <div className="flex items-center justify-between px-3 sm:px-4 py-2 border-b border-[#ffffff0a]">
              <div className="flex items-center gap-1.5 text-[#808086]">
